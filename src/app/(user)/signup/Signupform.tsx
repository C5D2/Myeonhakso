          ...
          <div className="flex justify-between ">
            ...
            <div className="flex align-bottom mb-2">
              <Button
                size="sm"
                radius="lg"
                onClick={handleEmailValidationClick}
              >
                중복확인
              </Button>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="w-50 h-50 border rounded-md ">
            <input
              ...
              {...register('attach', {
                required:
                  selectedType === 'seller' ? '이미지는 필수입니다.' : false,
              })}
            />
          </div>
          {isSubmitted && errors.attach && (
            <p className="text-red-500 text-sm mt-1">{errors.attach.message}</p>
          )}
        </div>
        {selectedType === 'seller' && (
          <div className="mb-8">
