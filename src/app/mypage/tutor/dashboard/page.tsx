import { fetchsaleProduct, fetchSellerOrderlist } from '@/data/fetchMypage';
...
export default async function Page() {
  ...
  const orderItem = await fetchSellerOrderlist();

  return (
    <>
      <h2 className="font-extrabold text-[30px] mb-10">대시보드</h2>
      <div className=" grid grid-flow-col grid-cols-12 grid-rows-8 gap-5 p-5 place-items-center sm:grid-rows-10">
        ...
        <div className="col-span-4 row-span-2 border border-gray-30 rounded-2xl w-full h-full sm:col-span-12 sm:row-span-1">
        ...
        <div className="col-span-12 row-span-3 border border-gray-30 rounded-2xl w-full h-full  sm:col-span-12 sm:row-span-2">
          ...
          <AnnualRevenue orderItem={orderItem} />
        </div>
        <div className="col-span-4 row-span-2 border border-gray-30 rounded-2xl w-full h-full sm:col-span-12 sm:row-span-1">
          <div className="flex flex-col items-center h-full">
            <div className="border-b w-full border-gray-30 p-5">
        ...
        <div className="col-span-6 row-span-3 border border-gray-30 rounded-2xl w-full h-full sm:col-span-12 sm:row-span-2">
          <div className="flex items-center border-b border-gray-30 p-5">
